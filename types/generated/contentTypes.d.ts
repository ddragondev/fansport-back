...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    comments: Attribute.Relation<
      ...
      'api::comment.comment'
    >;
    stories_views: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::story.story'
    >;
    ...
    teams: Attribute.Relation<
      ...
      'api::team.team'
    >;
    player_stats: Attribute.JSON;
    player_info: Attribute.JSON;
...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    caption: Attribute.String;
    slug: Attribute.UID & Attribute.CustomField<'plugin::field-nanoid.nanoid'>;
    ...
    widthRatio: Attribute.Integer & Attribute.DefaultTo<1>;
    heightRatio: Attribute.Integer & Attribute.DefaultTo<1>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
